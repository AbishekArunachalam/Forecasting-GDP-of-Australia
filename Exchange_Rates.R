...
Exchanges_Rates <- Exchanges_Rates %>% group_by(qtrDate) %>% summarize('Exchange Rate(AU$1=USD)' = mean(`Exchange Rate(AU$1=USD)`)) #Group by year quarters and calculate sum
